<template>
    <div class="">
        <div class="block" style="padding:40px;">
            <h2 style="margin:0 0 1em 0">机器人</h2>
            <div class="block-content">
                <el-form ref="form" label-width="120px" style="width:600px;">
                    ...
                    <el-form-item v-if="form.msgtype === 'image'" label="上传图片">
                        <el-upload class="upload-demo" :multiple='false' :data="{ type: this.form.msgtype }"
                            action="api/robot/upload" :on-success="eventUploadSuccess" name="file">
                    ...
                    <el-form-item v-else-if="form.msgtype === 'file'" label="上传文件">
                        <el-upload class="upload-demo" :multiple='false' action="api/robot/upload" :data="upload_data"
                            :on-success="eventUploadSuccess" name="file">
                            <el-button size="small" type="plain">点击上传</el-button>
